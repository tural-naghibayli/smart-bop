...
user_1 = User.create!(rig: rig_1, email: "user61@user.com", password: "password", name: "User_name_2", position: "Driller", company: "Odfjell", admin: false)
...
user_1 = User.create!(rig: rig_1, email: "user9@user.com", password: "password", name: "User_name_2", position: 'Driller', company: "Odfjell", admin: false)
